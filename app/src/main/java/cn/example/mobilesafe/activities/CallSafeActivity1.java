...
public class CallSafeActivity1 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_call_safe1);
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(number)) {
                    Toast.makeText(CallSafeActivity1.this, "号码不能为空", Toast.LENGTH_SHORT).show();
                    return;
                }
                String mode = "";
                if (cbPhone.isChecked() && cbSms.isChecked()) {
                    ...
                    Toast.makeText(CallSafeActivity1.this, "请勾选拦截模式", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private class CallSafeAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            ViewHolder holder;
            if (convertView == null) {
                convertView = View.inflate(CallSafeActivity1.this, R.layout.item_black_number_list, null);
            ...
            holder.ivDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (result) {
                        Toast.makeText(CallSafeActivity1.this, "删除成功", Toast.LENGTH_SHORT).show();
                        blackNumberInfos.remove(position);
                        adapter.notifyDataSetChanged();//刷新界面
                    } else {
                        Toast.makeText(CallSafeActivity1.this, "删除失败", Toast.LENGTH_SHORT).show();
                    }
                }
            });
            return convertView;
